...
public class CadVenda extends JFrame {
	...
	public CadVenda() {
		...
		gbl_panel.columnWidths = new int[] { 81, 86, 57, 119, 75, 77, 0 };
		gbl_panel.rowHeights = new int[] { 20, 40, 20, 20, 20, 20, 20, 20, 20,
				23, 0 };
